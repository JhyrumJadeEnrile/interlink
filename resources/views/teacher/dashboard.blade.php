...
@section('title', 'Coordinator Dashboard | InternLink')

@section('content')
<div class="page-inner">
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            <h3 class="fw-bold mb-3">Coordinator Dashboard</h3>
            <h6 class="op-7 mb-2">Monitor your assigned students' internship hours and progress.</h6>
        </div>
